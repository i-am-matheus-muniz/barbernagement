    ...
    <body width="100%">
        <div class="container-fluid img-fluid fundao">
            ...
            <center>
                ...
                <div class="row container-fluid">
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6446.jpg" alt=""/>
                    </div>
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6478.jpg" alt=""/>
                    </div>
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6481.jpg" alt=""/>
                    </div>
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6490.jpg" alt=""/>
                    </div>

                </div>
                <div class="row container-fluid">
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6514.jpg" alt=""/>
                    </div>
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6516.jpg" alt=""/>
                    </div>
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6494.jpg" alt=""/>
                    </div>
                    <div class="col-12 col-sm-3">
                        <img class="justify-content-center eventos_img" src="imagens/fotoseventos/IMG_6526.jpg" alt=""/>
                    </div>
