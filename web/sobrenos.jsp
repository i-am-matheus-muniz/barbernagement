...
<html>
    ...
    <body>
        <div class="container-fluid img-fluid">
            ...
            <div class="row" id="submenusobrenos">
                ...
                <div id="sobrenostexto" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <h1>Nossa Historia</h1><br>
                    <h2>Você conhece a historia da Limonada Barbearia? Sabe o porque
                        desse nome tão incomum, e um tanto quanto inusitado? Hoje, vamos<br> 
                        compartilhar um pouco sobre nossa história (...) A Limonada nasceu a partir 
                        da ideia de que devemos sempre olhar o lado positivo das coisas <br> 
                        e da vida, e em meio há uma fase ruim, sem muitas expectativas, surge uma
                        oportunidade de mergulhar de cabeça em algo que realmente lhe <br>
                        satisfazia e algo que sempre foi seu sonho, Fillipe Carvalho
                        Lopes, empresário,então decidiu torna-lo realidade! "Se a vida 
                        te der um limão, <br> 
                        faça uma limonada".Assim, nasceu a Limonada Barbearia. A alma da
                ...
                <div  id="sobrenosfoto"  class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <img style="border: 4px solid #CD9B6B;" src="imagens/sobrenos.jpg" alt="Unidade 2 - Bairro Campo do galvão"/>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h1> Missao</h1><br>
            <h2>Missão: estimular de maneira positiva, o corpo, mente e espírito. <br>
                Inspirar otimismo. Criar valores e fazer a diferença.</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h1>Valores<br></h1>
                <h2>
                    Deus , Família, Pessoas, Otimismo, Excelência
